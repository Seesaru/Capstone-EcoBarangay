...
class CollectorVerificationScreen extends StatefulWidget {
  ...
  const CollectorVerificationScreen({Key? key, required this.email})
      : super(key: key);

  @override
  State<CollectorVerificationScreen> createState() =>
      _CollectorVerificationScreenState();
}

class _CollectorVerificationScreenState
    extends State<CollectorVerificationScreen> {
  ...
  Future<void> _checkEmailVerification({bool silent = false}) async {
    ...
    try {
      bool isVerified = await _collectorAuthService.isCollectorVerified();
  ...
  Future<void> _resendVerificationEmail() async {
    ...
    try {
      User? user = _collectorAuthService.currentUser;
      if (user != null) {
