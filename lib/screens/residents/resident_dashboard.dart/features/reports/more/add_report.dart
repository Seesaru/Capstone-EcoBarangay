...
class _CreateReportScreenState extends State<CreateReportScreen> {
  ...
  Future<String?> _uploadImageToCloudinary() async {
    ...
    try {
      ...
      String fileName =
          'report_${_uuid.v4()}_${DateTime.now().millisecondsSinceEpoch}';
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final reportData = {
          ...
          'authorRole': _isAnonymous ? 'Anonymous' : 'Community Member',
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_residentBarangay.isNotEmpty)
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "Your Barangay: $_residentBarangay",
                              style: TextStyle(
                                fontSize: 14,
                                color: Colors.grey[700],
                              ),
                            ),
                            if (_residentAddress.isNotEmpty &&
                                _residentAddress != _residentBarangay)
                              Text(
                                "Your Address: $_residentAddress",
                                style: TextStyle(
                                  fontSize: 14,
                                  color: Colors.grey[700],
                                ),
