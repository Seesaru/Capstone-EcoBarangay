...
import 'dart:ui';
import '../reports/more/report_detail_dialog.dart';
...
class _ReportScreenState extends State<ReportScreen>
  ...
  String _selectedTimeFilter =
      'This Week'; // Change default to This Week to match announcement screen
  ...
  // Time filter options - Updated to match announcement screen
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          _buildTimeFilterChip(), // Changed to new time filter method
  ...
  Widget _buildReportCard(DocumentSnapshot report) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        ReportDetailDialog.show(context, data);
      },
      child: Container(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 4),
                                    Text(
                                      (data['location'] as String).length > 20
                                          ? '${(data['location'] as String).substring(0, 20)}...'
                        ...
                        // Title
                        Text(
                          data['title'] as String? ?? 'Untitled Report',
                          style: const TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                          ),
            ...
            Padding(
              ...
              child: Text(
                data['content'] as String? ?? 'No description provided.',
                style: TextStyle(
                  fontSize: 14,
                  height: 1.4,
                  color: Colors.grey[700],
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          data['authorRole'] as String? ?? 'Community Member',
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.grey[600],
                            fontStyle: data['isAnonymous'] == true
                                ? FontStyle.italic
                                : FontStyle.normal,
                          ),
                        ),
