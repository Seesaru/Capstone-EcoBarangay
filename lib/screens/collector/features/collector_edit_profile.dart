...
class CollectorEditProfileScreen extends StatefulWidget {
  ...
  const CollectorEditProfileScreen({
    Key? key,
...
class _CollectorEditProfileScreenState
  ...
  Future<String?> _uploadImage() async {
    ...
    try {
      ...
      String fileName =
          'collector_${userId}_${DateTime.now().millisecondsSinceEpoch}';

      // Create multipart request
      var request = http.MultipartRequest('POST', uri)
        ..fields['upload_preset'] = uploadPreset
        ..fields['folder'] = 'ecobarangay/collectors'
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color:
                    _phoneNumberError != null ? Colors.red : Colors.grey[300]!,
