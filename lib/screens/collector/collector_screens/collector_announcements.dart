...
import '../features/collector_announcement_detail_dialog.dart';

class CollectorAnnouncementsScreen extends StatefulWidget {
  const CollectorAnnouncementsScreen({Key? key}) : super(key: key);

  @override
  _CollectorAnnouncementsScreenState createState() =>
      _CollectorAnnouncementsScreenState();
}
...
class _CollectorAnnouncementsScreenState
  ...
  Widget _buildAdvancedAnnouncementCard(Map<String, dynamic> announcement) {
    ...
    return GestureDetector(
      onTap: () {
        // Show announcement detail dialog when card is tapped
        showCollectorAnnouncementDetailDialog(context, announcement);
      },
      child: Container(
